...
public class SoulStuffBlocks {
    // BUILDING BLOCKS
        // GLASS
    public static final Block SOUL_GLASS = registerBlock("soul_glass", new TransparentBlock(FabricBlockSettings.copy(Blocks.GLASS).mapColor(MapColor.BROWN)));
    public static final Block TINTED_SOUL_GLASS = registerBlock("tinted_soul_glass", new TintedGlassBlock(FabricBlockSettings.copy(SOUL_GLASS).mapColor(MapColor.BLACK)));
    public static final Block SOUL_GLASS_PANE = registerBlock("soul_glass_pane", new PaneBlock(FabricBlockSettings.copy(Blocks.GLASS_PANE).mapColor(MapColor.BROWN)));
        // STONE
            // ROUGH
    ...
    // LIGHT
    public static final Block SOULLIGHT = registerBlock("soullight", new Block(copy(Blocks.GLOWSTONE).luminance(value -> 12).mapColor(MapColor.DIAMOND_BLUE)));
    public static final Block NICK_O_LANTERN = registerBlock("nick_o_lantern", new CarvedPumpkinBlock(copy(Blocks.JACK_O_LANTERN).luminance(value -> 12).mapColor(MapColor.PURPLE)));
    ...
    private static FabricBlockSettings copy(Block base) {
